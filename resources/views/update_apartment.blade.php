            ...
            <div class="py-4 pb-8">
                <h2> Укажите новые данные квартиры </h2>
                    ...
                    <div class="mt-8 max-w-md">
                        <form method="post" action="/update/{{$apartment->id}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            @method('PUT')
                            ...
                            <div class="block">
                                ...
                                <input name="address" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{$apartment->address}}">
                            </div>

                            <div class="block">
                                <label for="field1" class="py-4 text-gray-700 font-bold">Укажите новую стоимость</label>
                                <input name="price" type="number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{$apartment->price}}">
                            </div>

                            <div class="block">
                                <label for="field1" class="py-4 text-gray-700 font-bold">Укажите кол-во комнат</label>
                                <input name="rooms" type="number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{$apartment->rooms}}">
                            </div>

                            <div class="block">
                                <label for="field1" class="py-4 text-gray-700 font-bold">Укажите площадь (м²)</label>
                                <input name="square" type="number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{$apartment->square}}">
                            </div>

                            <div class="block">
                                <label for="field1" class="py-4 text-gray-700 font-bold">Укажите этаж</label>
                                <input name="floor" type="number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{$apartment->floor}}">
                            </div>
                            ...
                            <div class="block">
                                ...
                                <textarea name="description" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" rows="3">{{$apartment->description}}</textarea>
                            </div>
